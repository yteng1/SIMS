...
namespace SIMS {
	...
	/// Summary for SpecAdd
	/// </summary>
	public ref class SpecAdd : public System::Windows::Forms::Form
	{
	public:
		SpecAdd(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(323, 98);
			...
			this->button1->Click += gcnew System::EventHandler(this, &SpecAdd::button1_Click);
			// 
			// label1
			// 
			...
			this->label1->Text = L"Weight (Ct)";
			// 
			// textBox1
			// 
			this->textBox1->AcceptsReturn = true;
			this->textBox1->AcceptsTab = true;
			this->textBox1->Location = System::Drawing::Point(150, 38);
			this->textBox1->Margin = System::Windows::Forms::Padding(1, 1, 1, 1);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(74, 21);
			...
			this->textBox2->Location = System::Drawing::Point(150, 67);
			...
			this->ClientSize = System::Drawing::Size(449, 156);
...
#pragma endregion
	private: void AutoSetName(void){
				 ...
				 this->Text = L"Add Record with Diameter: "+SharedData::diameter+"  Type1: "+SharedData::type1+"  Type2: "+SharedData::type2+"  "+SharedData::status+" ";	 
		 }
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {


				 MySqlConnection^ conDataBase = gcnew MySqlConnection(SharedData::constring);
				 double di = System::Double::Parse(SharedData::diameter);
				 double wei = System::Double::Parse(textBox1->Text);
				 double cos = System::Double::Parse(textBox2->Text);
				 MySqlCommand^ cmdDataBase = gcnew MySqlCommand("Insert into stoneinventory.stonetable(Diameter,Weight,Cost,Type1,Type2) values("+di+","+wei+","+cos+",'"+SharedData::type1+"','"+SharedData::type2+"');",conDataBase);
				 try{
						conDataBase->Open();
